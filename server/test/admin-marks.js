...
describe('Admin Marks', () => {
    ...
    describe('/GET Marks', () => {
        it('it should get marks by page', (done) => {
            Mark.insertMany(mock, function (err, inserted) {
                chai.request(server)
                    .get('/admin/marks?page=1&pageSize=2')
                    .set('Authorization', mockToken.admin)
                    .end((err, res) => {
                        res.should.have.status(200);
                        res.body.message.should.eq('Marks retrieved successfully');
    ...
    describe('/GET Marks', () => {
        it('it should get marks by page and sort them by mark', (done) => {
            Mark.insertMany(mock, function (err, inserted) {
                ...
                const sortDir = 1;
                chai.request(server)
                    .get(`/admin/marks?page=1&pageSize=2&sort=${sort}&sortDir=${sortDir}`)
                    .set('Authorization', mockToken.admin)
                    .end((err, res) => {
                        res.should.have.status(200);
                        res.body.message.should.eq('Marks retrieved successfully');
    ...
    describe('/GET Marks', () => {
        it('it should get marks and sort them by mark', (done) => {
            Mark.insertMany(mock, function (err, inserted) {
                ...
                const sortDir = -1;
                chai.request(server)
                    .get(`/admin/marks?sort=${sort}&sortDir=${sortDir}`)
                    .set('Authorization', mockToken.admin)
                    .end((err, res) => {
                        res.should.have.status(200);
                        res.body.message.should.eq('Marks retrieved successfully');
